...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white">
    <div class="container px-4 px-lg-5">
        <span class="globalnav-image-regular globalnav-link-image"><svg height="44" viewBox="0 0 14 44" width="14"
...
<header class="py-5">
    <div id="carouselExampleCaptions" class="carousel carousel-dark slide bg-light" data-bs-ride="carousel">
        ...
        <div class="carousel-inner py-5">
            ...
            <c:forEach var="item" items="${ slides }" varStatus="index">
                <c:if test="${ index.first }"><div class="carousel-item active"></c:if>
                <c:if test="${ not index.first }"><div class="carousel-item"></c:if>
                    <img src="<c:url value="/assets/user/images/slides/${ item.image }"/>"
                         class="rounded mx-auto d-block w-25"
                         alt="...">
                    <div class="carousel-caption">
                        <h5>${ item.slideName }</h5>
